...
public class ClienteFTPBasico extends JFrame {
    ...
    private static JList listaDirec = new JList();
    ...
    private String direcSelec = direcInicial;
    private String ficheroSelec = "";

    

// constructor
    public ClienteFTPBasico(String servidor, String usuario, String password, String direcInicial) throws IOException {
        super("CLIENTE BÁSICO FTP");
        
        this.servidor = servidor;
        this.user = usuario;
        this.pasw = password;
        this.direcInicial = direcInicial;

        System.out.println("Conectandose a " + servidor);

        //usamos un command listener para mostrar en consola todos los mensajes comando/respuesta con el servidor
        cliente = new FTPClient();//cliente FTP
    ...
    // -----------------------------------------------------------------------------
    private void llenarLista(FTPFile[] files, String direc2) {
        if (files == null) {
            return;
        }
